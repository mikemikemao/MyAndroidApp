...
public class MyRender2 implements GLSurfaceView.Renderer {
    private static final String TAG = "MyRender2";
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String vertexCode = ShaderHelper.loadAsset(MyApplication.getContext().getResources(), R.raw.simple_vertex_shader);
        String fragmentCode = ShaderHelper.loadAsset(MyApplication.getContext().getResources(), R.raw.simple_fragment_shader);
        //创建着色器程序
